...
public class TestUtils {
    ...
    public static News createNewsWithLongContentFromPerfil() {
        List<String> keywords1 = new LinkedList<>(Arrays.asList("A", "B", "C", "D", "E"));
        LocalDateTime date = LocalDateTime.now();
        return News.builder()
    ...
    public static News createNewsWithLongContentFromClarin() {
        LocalDateTime date = LocalDateTime.now();
        return News.builder()
                .url("https://www.clarin.com/economia/siguen-largas-filas-estaciones-servicio-cargar-nafta-gobierno-atribuye-psicosis_0_M9NfwNZoFo.html")
                .section("aSection")
                .releaseDate(date).build();
    }
}
